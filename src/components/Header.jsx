	...
	return (
		<header className="header">
			<div className="container-fluid container-min-max-width d-flex justify-content-between align-items-center">
				<Link to="/">
					<img src={Logo} alt="Laguna Shop" className="logo" />
				</Link>
				<div>
					{userData ? (
					...
					<div className="d-flex flex-column flex-sm-row">
						<div className="d-flex align-items-center justify-content-end">
							{userData ? (
								<>
									<h2 className="logout-text mx-3" onClick={signOutUser}>
										Logout
									</h2>
									<Link to="/admin">
										<h2 className="logout-text mx-3">Admin Panel</h2>
									</Link>
								</>
							) : (
								<Link to="/login">
									<h3 className="mx-3">Login</h3>
								</Link>
							)}
						</div>
						<div className="d-flex align-items-center justify-content-end">
							<Link to="/favorites">
								<FullHeart className="mx-1 text-bold" />
							</Link>
							<p className="my-2 mr-1 number-of-products text-white">
								{numberOfFavoriteProducts}
							</p>
							<Link to="/cart">
